...
function StatCardSkeleton() {
  return (
    <div className="relative overflow-hidden rounded-lg bg-white px-4 pt-5 pb-12 shadow-sm sm:px-6 sm:pt-6 border border-gray-200">
      <div className="animate-pulse">
        <div className="flex items-start">
          <div className="rounded-md bg-gray-300 p-3 w-12 h-12"></div>
          <div className="ml-4 flex-1">
            <div className="h-4 bg-gray-300 rounded w-24 mb-2"></div>
            <div className="h-6 bg-gray-300 rounded w-16 mb-2"></div>
            <div className="flex items-center">
              <div className="h-4 bg-gray-300 rounded w-4 mr-1"></div>
              <div className="h-4 bg-gray-300 rounded w-8"></div>
            </div>
          </div>
        </div>
        <div className="absolute inset-x-0 bottom-0 bg-gray-50 px-4 py-4">
...
export default function StatsWithIcons({ stats = defaultStats, isLoading = false }: StatsWithIconsProps) {
  if (isLoading) {
    return (
      <div>
        <h3 className="text-base font-semibold text-gray-900 mb-4">System Statistics</h3>
